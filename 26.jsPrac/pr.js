...
// let filtered = employees.filter((item) => item.salary > 2000);
// console.log(filtered);

//   #ortalama maaşı 10000-dən çox olan və departamenti "IT" olanları çapa verən program tərtib edin.

// let filtered = employees.filter((item) => item.salary > 10000 && item.department === "IT");
// console.log(filtered);

//   #sadecə department "HR" olanları yeni array'a yığıb, həmin arrayı console edin

// let filtered = employees.filter((item) =>  item.department === "HR");
// console.log(filtered);
